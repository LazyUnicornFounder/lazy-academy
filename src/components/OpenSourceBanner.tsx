  ...
  <section className="border-t border-border py-16">
    <div className="container px-4 max-w-3xl mx-auto text-center">
      ...
      <p className="text-muted-foreground text-base leading-relaxed mb-6 max-w-xl mx-auto">
        Lazy Academy is fully open source. We believe in building in public — every line of code,
        every feature, every decision is transparent. Fork it, learn from it, or contribute to make it better.
      </p>
      <a
        href="https://github.com/LazyUnicornFounder/lazy-academy"
        target="_blank"
      ...
      <p className="text-muted-foreground/60 text-sm mt-4">
        Part of{" "}
        <a href="https://lazyfounderventures.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-muted-foreground">
          Lazy Founder Ventures
        </a>
        {" "}— building autonomous businesses in public.
      </p>
    </div>
  </section>
);
